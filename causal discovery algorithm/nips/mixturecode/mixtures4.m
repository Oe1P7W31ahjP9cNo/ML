function [bestk,bestpp,bestmu,bestcov,dl,countf,estk0,estpp0,estmu0,estcov0] = mixtures4(y,kmin,kmax,regularize,th,covoption)
%
% 
% Usage syntax:
...
while(cont)    % this inner loop is the component-wise EM algorithm with the
   ...
   while comp <= k
            ...
            if sum(estpp) == 0.0
              throw(MException('mixtures4:error','sum(estpp) became zero'));
            end
