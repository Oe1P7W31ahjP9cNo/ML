...
def get_new_data():
    train_img=np.load("60000_test.npy")
    test_img=np.load("10000_test.npy")
...
def operate_data():#二值化
    print("start loading")
    train_img,train_label,test_img,test_label = get_new_data()
    #归一化，调整为列向量
    ...
    return [train_img_normlization[1000:10000],train_label[1000:10000],test_img_normlization,test_label]
